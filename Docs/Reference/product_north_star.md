...
As a user, the first useful output for me is to see charts of data generated by this system. That's the best way I can validate if it's behaving like a real market would. The launch-and-iterate cycle should use this output as a mechanism to improve. I don't want to overbuild, but I want to iterate with this goal in mind.
