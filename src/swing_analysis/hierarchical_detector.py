...
def calibrate(
    bars: List[Bar], config: SwingConfig = None
    ...
    Args:
        ...
        config: SwingConfig for detection parameters.

    Returns:
        Tuple of (detector, all_events) where detector is ready for
        continued use and all_events is the complete event history.
