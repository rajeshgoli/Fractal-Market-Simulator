...
class ReferenceConfig:
    ...
    Attributes:
        ...
        small_origin_tolerance: Origin breach tolerance for S/M scale references.
            Location past 1.0 that's allowed before invalidation.
        big_origin_tolerance: Origin breach tolerance for L/XL scale references.
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "ReferenceConfig":
        ...
        return cls(
            ...
            small_origin_tolerance=data.get("small_origin_tolerance", 0.05),
            big_origin_tolerance=data.get("big_origin_tolerance", 0.15),
    ...
    def with_scale_thresholds(
        ...
        return ReferenceConfig(
            ...
            big_origin_tolerance=self.big_origin_tolerance,
    ...
    def with_tolerance(
        ...
        big_origin_tolerance: float = None,
    ) -> "ReferenceConfig":
        """
        ...
        Args:
            small_origin_tolerance: Tolerance for S/M references (e.g., 0.05 = 5%).
            big_origin_tolerance: Tolerance for L/XL references (e.g., 0.15 = 15%).
        """
        return ReferenceConfig(
            xl_threshold=self.xl_threshold,
            l_threshold=self.l_threshold,
            ...
            big_origin_tolerance=big_origin_tolerance if big_origin_tolerance is not None else self.big_origin_tolerance,
            big_range_weight=self.big_range_weight,
            big_impulse_weight=self.big_impulse_weight,
            big_recency_weight=self.big_recency_weight,
            small_range_weight=self.small_range_weight,
